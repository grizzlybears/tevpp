...
{
public:
    PooledMsgSwitch * msg_switch;           // doesn't maintain life-cycle. 
...
public: 
    ...
    virtual void do_in_worker_thread()
    {
        ...
        // It is a hard job, it takes time 
        sleep(1);
...
int main(int argc, char *argv[])
{
	...
	{ 
        ...
        PooledMsgSwitch msg_switch(&loop);
        ...
        msg_switch.workers.create_new_worker(gPoolSize);
        ...
        msg_switch.workers.dismiss_all_workers();
        msg_switch.workers.wait_until_all_workers_gone();
	}
